module ACO2DI
    include("../../../Data.jl")
    include("../../StochasticOptimization/ACO.jl")

    export aco2di

    function fitness(individual::Vector{Int}, 
                     si_util::Utility, 
    ...
    function aco2di(transactions::Vector{Transaction}, 
        ...
        for (si_idx, si) in enumerate(sis)
            ...
            aco = ACO(length(s_tids), M, max_genes_size)
