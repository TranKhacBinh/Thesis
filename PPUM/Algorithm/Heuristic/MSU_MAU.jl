module MSU_MAU
    ...
    function maximum_sensitive_utility_maximum_item_utility(si::ItemSet, transactions::Vector{Transaction}, util_table::UtilTable)
        ...
        for item in si
            ...
            if item_util > max_item_util
                max_item_util = item_util
                selected_item = item
            end
        end
    ...
    function msu_mau(transactions::Vector{Transaction}, util_table::UtilTable, sis::Vector{ItemSet}, huis::Dict{ItemSet, Utility}, min_util::Utility)
        ...
        for si in sis
            ...
            while diff >= 0
                selected_item, selected_tid = maximum_sensitive_utility_maximum_item_utility(si, sanitized_transactions, util_table)
